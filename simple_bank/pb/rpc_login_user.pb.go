...
type LoginUserResponse struct {
	...
	AccessTokenExpiresAt  *timestamp.Timestamp `protobuf:"bytes,3,opt,name=accessTokenExpiresAt,proto3" json:"accessTokenExpiresAt,omitempty"`
...
type RenewAccessTokenResponse struct {
	...
	AccessTokenExpiresAt *timestamp.Timestamp `protobuf:"bytes,2,opt,name=accessTokenExpiresAt,proto3" json:"accessTokenExpiresAt,omitempty"`
}

func (x *RenewAccessTokenResponse) Reset() {
	*x = RenewAccessTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_login_user_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RenewAccessTokenResponse) Descriptor() ([]byte, []int) {
	return file_rpc_login_user_proto_rawDescGZIP(), []int{3}
}
...
func (x *RenewAccessTokenResponse) GetAccessTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
		return x.AccessTokenExpiresAt
	}
	return nil
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8c, 0x01, 0x0a,
	...
	0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x4e, 0x0a, 0x14, 0x61,
	...
	0x65, 0x6e, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x10, 0x5a, 0x0e, 0x73,
...
var file_rpc_login_user_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_rpc_login_user_proto_depIdxs = []int32{
	4, // 0: pb.LoginUserResponse.accessTokenExpiresAt:type_name -> google.protobuf.Timestamp
	4, // 1: pb.LoginUserResponse.refreshTokenExpiresAt:type_name -> google.protobuf.Timestamp
	5, // 2: pb.LoginUserResponse.user:type_name -> pb.User
	4, // 3: pb.RenewAccessTokenResponse.accessTokenExpiresAt:type_name -> google.protobuf.Timestamp
...
func file_rpc_login_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_login_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_login_user_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
